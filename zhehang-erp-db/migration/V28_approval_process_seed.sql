...
SELECT '付款审批', 'payment', 'finance', 1, '对外付款申请',
  ...
  '{"nodes":[{"id":"start","type":"start","name":"开始"},{"id":"node1","type":"approval","name":"部门主管审批","assigneeType":"role","assigneeValue":"dept_leader"},{"id":"node2","type":"approval","name":"财务审批","assigneeType":"role","assigneeValue":"finance_manager"},{"id":"end","type":"end","name":"结束"}],"edges":[{"from":"start","to":"node1"},{"from":"node1","to":"node2"},{"from":"node2","to":"end"}]}',
  1, 1
...
SELECT '收款审批', 'receipt', 'finance', 1, '收款确认申请',
  ...
  '{"nodes":[{"id":"start","type":"start","name":"开始"},{"id":"node1","type":"approval","name":"财务审批","assigneeType":"role","assigneeValue":"finance_manager"},{"id":"end","type":"end","name":"结束"}],"edges":[{"from":"start","to":"node1"},{"from":"node1","to":"end"}]}',
  1, 1
...
SELECT '会议室预约审批', 'meeting_room', 'admin', 1, '会议室预约申请',
  ...
  '{"nodes":[{"id":"start","type":"start","name":"开始"},{"id":"node1","type":"approval","name":"行政主管审批","assigneeType":"role","assigneeValue":"admin_manager"},{"id":"end","type":"end","name":"结束"}],"edges":[{"from":"start","to":"node1"},{"from":"node1","to":"end"}]}',
  1, 1
...
SELECT '合同审批', 'contract', 'admin', 1, '合同签署审批',
  ...
  '{"nodes":[{"id":"start","type":"start","name":"开始"},{"id":"node1","type":"approval","name":"部门主管审批","assigneeType":"role","assigneeValue":"dept_leader"},{"id":"node2","type":"approval","name":"法务/财务审批","assigneeType":"role","assigneeValue":"finance_manager"},{"id":"node3","type":"approval","name":"总经理审批","assigneeType":"role","assigneeValue":"general_manager"},{"id":"end","type":"end","name":"结束"}],"edges":[{"from":"start","to":"node1"},{"from":"node1","to":"node2"},{"from":"node2","to":"node3"},{"from":"node3","to":"end"}]}',
  1, 1
...
SELECT '入职审批', 'onboard', 'hr', 1, '新员工入职申请',
  ...
  '{"nodes":[{"id":"start","type":"start","name":"开始"},{"id":"node1","type":"approval","name":"部门主管审批","assigneeType":"role","assigneeValue":"dept_leader"},{"id":"node2","type":"approval","name":"人事审批","assigneeType":"role","assigneeValue":"hr_manager"},{"id":"end","type":"end","name":"结束"}],"edges":[{"from":"start","to":"node1"},{"from":"node1","to":"node2"},{"from":"node2","to":"end"}]}',
  1, 1
...
SELECT '调岗审批', 'transfer', 'hr', 1, '岗位异动申请',
  ...
  '{"nodes":[{"id":"start","type":"start","name":"开始"},{"id":"node1","type":"approval","name":"原部门主管审批","assigneeType":"role","assigneeValue":"dept_leader"},{"id":"node2","type":"approval","name":"人事审批","assigneeType":"role","assigneeValue":"hr_manager"},{"id":"end","type":"end","name":"结束"}],"edges":[{"from":"start","to":"node1"},{"from":"node1","to":"node2"},{"from":"node2","to":"end"}]}',
  1, 1
...
SELECT '离职审批', 'resign', 'hr', 1, '员工离职申请',
  ...
  '{"nodes":[{"id":"start","type":"start","name":"开始"},{"id":"node1","type":"approval","name":"部门主管审批","assigneeType":"role","assigneeValue":"dept_leader"},{"id":"node2","type":"approval","name":"人事审批","assigneeType":"role","assigneeValue":"hr_manager"},{"id":"node3","type":"approval","name":"总经理审批","assigneeType":"role","assigneeValue":"general_manager"},{"id":"end","type":"end","name":"结束"}],"edges":[{"from":"start","to":"node1"},{"from":"node1","to":"node2"},{"from":"node2","to":"node3"},{"from":"node3","to":"end"}]}',
  1, 1
