...
public class SysLogController {
    ...
    @PreAuthorize("@perm.hasAnyPermission('system:log:list', 'log:login:list')")
    ...
    @PreAuthorize("@perm.hasAnyPermission('system:log:remove', 'log:login:remove')")
    ...
    @PreAuthorize("@perm.hasAnyPermission('system:log:export', 'log:login:export')")
    ...
    @PreAuthorize("@perm.hasAnyPermission('system:log:list', 'log:oper:list')")
    ...
    @PreAuthorize("@perm.hasAnyPermission('system:log:remove', 'log:oper:remove')")
    ...
    @PreAuthorize("@perm.hasAnyPermission('system:log:export', 'log:oper:export')")
