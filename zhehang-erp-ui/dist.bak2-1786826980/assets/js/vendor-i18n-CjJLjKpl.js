import { $t as shallowRef, Ct as onUnmounted, G as Fragment, Gt as isRef, St as onMounted, Ut as effectScope, V as _asyncToGenerator, X as computed, Xt as ref, at as createVNode, ct as getCurrentInstance, dt as h, g as _objectSpread2, pt as inject, q as Text, st as defineComponent, zt as watch } from "./vendor-Cuzsyfny.js";
...
function baseCompile(message, options = {}) {
	...
	return _objectSpread2(_objectSpread2({}, baseCompile$1(message, options)), {}, { detectError });
}
function compile(message, context) {
	if (isString$1(message)) {
		...
		const { ast, detectError } = baseCompile(message, _objectSpread2(_objectSpread2({}, context), {}, {
			location: false,
			jit: true
		}));
