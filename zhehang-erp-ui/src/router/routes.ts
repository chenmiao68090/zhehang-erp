...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  // V238 旧合同管理页已退役(数据源 biz_order 为空),历史链接统一落到代理记账合同。
  ...
  { path: '/leads/service-renewal', redirect: '/feige-order-contract/contracts', meta: { hidden: true } },
  ...
  { path: '/customer/service-renewal', redirect: '/feige-order-contract/contracts', meta: { hidden: true } },
