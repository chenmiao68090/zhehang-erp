<template>
  <div class="task-workbench task-workbench-page goal-page">
    ...
    <section class="toolbar-card">
      ...
      <el-button v-if="capabilities.manager" type="primary" :disabled="!roles.length" @click="formRef?.open()">新增目标</el-button>
    ...
    <el-empty v-if="!loading&&goals.length===0" :description="capabilities.manager&&roles.length?'暂无目标，可点击上方新增':'暂无目标'"/>
